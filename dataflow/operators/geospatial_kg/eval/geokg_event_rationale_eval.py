...
from dataflow.prompts.diverse_kg.geokg import GeoKGQuadrupleRationalePrompt


class GeoKGEventRationaleEvaluator(OperatorABC):
    ...
    def __init__(
        ...
        self.prompt_manager = GeoKGQuadrupleRationalePrompt(lang)
